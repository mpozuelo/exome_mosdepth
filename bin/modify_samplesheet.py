...
def add_bed_file(FileIn,FileOut):
    ...
    interval = {'TWIST': intervalfolder + 'TWIST_hg19.interval_list', 'IDT': intervalfolder + 'IDT_hg19.interval_list', 'Agilent': intervalfolder + 'SureSelect_v6_hg19.interval_list'}    # Write header
    #fo.write("%s\n" %('\t'.join(l_th[1:])))
